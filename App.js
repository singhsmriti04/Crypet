...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const daiTokenAddress = "0xF4AC02f678D9F9c1098001842239905a2d67c32f" // Replace DAI Address Here
    const daiTokenMock = new web3.eth.Contract(DaiTokenMock.abi, daiTokenAddress)
    this.setState({ daiTokenMock: daiTokenMock })
    balance = await daiTokenMock.methods.balanceOf(this.state.account).call()
    this.setState({ balance: web3.utils.fromWei(balance ? balance.toString() : '', 'Ether') })
            ...
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto" style={{ width: "500px" }}>
                ...
                <form onSubmit={(event) => {
                  ...
                  let amount = window.web3.utils.toWei(this.amount.value, 'Ether')
